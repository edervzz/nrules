...
const KVItemForm = ({ onSubmit: onOk, onCancel: onNotOk }: Props) => {
    ...
    return (
        <Modal size="sm" show backdrop="static" keyboard={false}>
            ...
            >
                <Modal.Header>
                    <Modal.Title>{Messages.ADDOUTPUT}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container className="d-flex justify-content-center">
                        <Form.Group className="mb-3">
                            <Form.Label>{Messages.OUTPUTNAME}</Form.Label>
                            <Form.Control
