...
export default class Messages{
    ...
    static RULESTRATEGY = i18next.t("common:rulestrategy");
    static RULESTRATEGY_SELECT = i18next.t("common:rulestrategy_select");
    static RULESTRATEGY_EARLY = i18next.t("common:rulestrategy_early");
    static RULESTRATEGY_BASE = i18next.t("common:rulestrategy_base");
    static RULESTRATEGY_ALL = i18next.t("common:rulestrategy_all");
