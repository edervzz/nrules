...
class Validator(ABC):
    ...
    def validate_and_throw(self, request):
        ...
        if len(self._messages_codes) > 0:
            raise BadRequest(json.dumps(self._messages_codes))
