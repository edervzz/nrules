...
class CreateTenantHandler:
    ...
    def handler(self, request: CreateTenantRequest) -> CreateTenantResponse:
        ...
        self.repository.tenant.create(request.tenant_release)
        self.repository.tenant_stage.create(request.tenant_stage)
        ...
        return CreateTenantResponse(
            ...
            request.tenant_release.id,
            request.tenant_release.name)
